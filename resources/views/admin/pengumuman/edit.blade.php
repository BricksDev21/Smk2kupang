...
@section('content')
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.updatePengumuman') }}">
            @csrf
            ...
            <label>Status</label>
                        ...
                        <option disabled="">- PILIH STATUS -</option><br>
                        <option selected="selected">{{ old('status', $pengumuman->status) }}</option>
                            <option value="Terbaru">Terbaru</option>
                            <option value="Terbaru">Populer</option>
                        </select>
