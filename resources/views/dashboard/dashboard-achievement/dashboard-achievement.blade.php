<div class="container mx-auto mt-10 mb-20">
    ...
    <nav class="mb-8 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 items-center justify-between">
        ...
        <!-- navigation-add-news -->
        <button type="button" class="w-full col-span-2 md:col-span-4 lg:col-span-1 flex items-center gap-3 bg-sky-500 p-6 rounded-2xl shadow-xl hover:translate-y-1 hover:shadow-lg transition-all" data-modal-toggle="add">
            <i class="bi bi-plus-circle fa-lg text-white"></i>
            <span class="text-sm font-medium text-white">Tambah Prestasi Baru</span>
        </button>
            ...
            <div class="relative w-full max-w-md h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="py-6 px-6 lg:px-8">
                        <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambah Prestasi</h3>
                        <form class="space-y-6" action="#">
                            <div class="flex flex-col gap-6">
                                <div>
                                    ...
                                    <input type="text" id="achievement" class="disabled:text-gray-500 p-4 w-full text-gray-900 bg-gray-200 rounded-xl border-none sm:text-md focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-400 dark:focus:border-sky-400">
                                </div>
                                <div>
                                    <label for="name" class="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-300">Nama Siswa</label>
                                    <input type="text" id="name" class="disabled:text-gray-500 p-4 w-full text-gray-900 bg-gray-200 rounded-xl border-none sm:text-md focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-400 dark:focus:border-sky-400">
                                </div>
                                <div>
                                    <label for="level" class="block mb-2 text-sm font-medium text-gray-500 dark:text-gray-300">Tingkat</label>
                                    <input type="text" id="level" class="disabled:text-gray-500 p-4 w-full text-gray-900 bg-gray-200 rounded-xl border-none sm:text-md focus:ring-sky-500 focus:border-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-400 dark:focus:border-sky-400">
                                </div>
